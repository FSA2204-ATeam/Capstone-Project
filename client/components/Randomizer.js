...
const Randomizer = () => {
  ...
  const events = [
    ...
    },
    {
      ...
      datePart: "Jul 5",
      permalink:
        "http://www1.nyc.gov/events/its-my-park-at-sunset-park/388104/1",
    ...
    },
    {
      ...
      address:
        "Flushing Meadows Corona Park - Grand Central Pkwy, Van Wyck Exwy",
      eventLat: "40.7400275",
  ...
  // for purposes of this function - assume all preference filtering + sentiment analysis has been done
